...
<body>
    ...
    <div class="content">
        <div class="form-container">
            <div class="powerbi-form">

            <?= Html::a('View PowerBI', ['view-powerbi'], ['class' => 'btn btn-success bg-success text-light', 'style' => ' background:#CCCCCC; margin-bottom: 10px;']) ?>

                <h3 class="text-center text-success mb-4">Add PowerBI</h3>
