...
<body>
    <div class="user-view ms-5">
        <h4 class="text-center text-success" style="margin-left:180px"><?=Html::encode($this->title)?></h4>
        <?= Html::a('Add User', ['add-user'], ['class' => 'btn btn-success bg-success text-light', 'style' => 'margin-left: 200px; background:#CCCCCC; margin-bottom: 10px;']) ?>
