...
<body>
    ...
    <div class="content">
        <div class="form-container">
            ...
            <?= Html::a('View AX', ['view-ax'], ['class' => 'btn btn-success bg-success text-light', 'style' => 'background:#CCCCCC; margin-bottom: 10px;']) ?>

                <h3 class="text-center text-success mb-4">Add AX</h3>
