...
<body>
    ...
    <div class="sales-view ms-5">
        <h4 class="text-center text-success" style="margin-left:95px"><?= Html::encode($this->title) ?></h4>
        <?= Html::a('Add Sale', ['add-sales'], ['class' => 'btn btn-success bg-success text-light', 'style' => 'margin-left: 250px; background:#CCCCCC; margin-bottom: 10px;']) ?>
        <table style="margin-left:250px" class="table table-bordered w-75">
            <tr>
                <th>Serial Number</th>
                <th>Sub Head</th>
                <!-- <th>Head Copy</th> -->
            ...
            <tr>
                ...
                <td>
                    <div class="btn-group" role="group">
                        <?= Html::a('View', ['view-sales-details', 'serialNumber' => $model->serialNumber], ['class' => 'btn  rounded btn-success ms-1']) ?>
