...
/* @var $model common\models\Fieldservice */

$this->title = 'Field Service';
$this->params['breadcrumbs'][] = ['label' => 'Field Service List', 'url' => ['fieldservice/view-fieldservice'], 'class' => 'text-success'];
