    ...
    <div class="content">
        <div class="form-container">
            <div class="bc-form">
                ...
                <?= Html::a('View Business Central', ['view-bc'], ['class' => 'btn btn-success bg-success text-light', 'style' => 'background:#CCCCCC; margin-bottom: 10px;']) ?>

                <h3 class="text-center text-success mb-4">Add Business Central</h3>
