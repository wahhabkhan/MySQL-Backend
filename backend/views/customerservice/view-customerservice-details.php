...
/* @var $model common\models\Customerservice */

$this->title = 'Customer Service';
$this->params['breadcrumbs'][] = ['label' => 'Customer Service List', 'url' => ['customerservice/view-customerservice'], 'class' => 'text-success'];
