...
$this->title = 'Customer Services List';
...
<body>
    ...
    <div class="customerservice-view ms-5">
        <h4 class="text-center text-success" style="margin-left:95px"><?= Html::encode($this->title) ?></h4>
        <?= Html::a('Add Customer Service', ['add-customerservice'], ['class' => 'btn btn-success bg-success text-light', 'style' => 'margin-left: 195px; background:#CCCCCC; margin-bottom: 10px;']) ?>
            ...
            <tr>
                ...
                <td>
                    <div class="btn-group" role="group">
                        <?= Html::a('View', ['view-customerservice-details', 'serialNumber' => $model->serialNumber], ['class' => 'btn  rounded btn-success ms-1']) ?>
