...
<body>
    ...
    <div class="content">
        <div class="form-container">
            <div class="office365-form">

            <?= Html::a('View Office365', ['view-office365'], ['class' => 'btn btn-success bg-success text-light', 'style' => ' background:#CCCCCC; margin-bottom: 10px;']) ?>

                <h3 class="text-center text-success mb-4">Add Office 365</h3>
...
<script>
    console.log('Route:', <?= json_encode(\yii\helpers\Url::toRoute(['powerbi/add-powerbi'])); ?>);
</script>
